...
Class XLSXWriter
{
	...
	public function writeSheet(array $data, $sheet_name='', array $header_types=array() )
	{
		...
		foreach($data as $i=>$row)
		{
			...
			foreach($row as $k=>$v)
			{
				$this->writeCell($fd, $i+$header_offset, $n, $v, $cell_formats_arr[$k]);
                $n++;
			}
			fwrite($fd, '</row>');
		}
	...
	protected function writeCell($fd, $row_number, $column_number, $value, $cell_format)
	{
		...
		static $styles = array('General'=>2,'Decimal'=>4,'Fecha'=>5,'Moneda'=>3,'Entero'=>1,'Texto'=>6,'FechaHora'=>7);
...
<styleSheet xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006"
    ...
    <cellStyles count="8">
        <cellStyle name="FechaHora" xfId="7"/>
        <cellStyle name="General" xfId="2"/>
        <cellStyle name="MiDecimal" xfId="4"/>
        <cellStyle name="MiFecha" xfId="5"/>
        <cellStyle name="MiMoneda" xfId="3"/>
        <cellStyle name="Normal" xfId="0" builtinId="0"/>
        <cellStyle name="NumeroEntero" xfId="1"/>
        <cellStyle name="Texto" xfId="6"/>
    </cellStyles>
    <dxfs count="0"/>
