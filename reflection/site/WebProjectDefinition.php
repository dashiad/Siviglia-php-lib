...
class WebProjectDefinition extends \lib\reflection\base\BaseDefinition
{
    ...
    {
         $path=str_replace(implode(DIRECTORY_SEPARATOR,explode("/","/lib/reflection/site/WebProjectDefinition.php")),"",__FILE__);         
